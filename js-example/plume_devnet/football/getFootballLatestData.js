...
const rpcEndpoint = 'https://test-rpc.plumenetwork.xyz'
const contractAddress = '0x98DBc6c45c7895131B66147CDd6565f146c5585A';
...
async function getLatestData() {
  ...
  try {
    ...
    console.log(result)
    // 0x0000000000000021000000000000000200000000000000220000000000000000
    const home = parseInt(result.substring(0, 18))
    const homeScore = parseInt("0x"+result.substring(18, 34))
    const away = parseInt("0x"+result.substring(34, 50))
    const awayScore = parseInt("0x"+result.substring(50))
    console.log("homeID:",home,"homeScore",homeScore, "awayID:",away, "awayScore",awayScore)

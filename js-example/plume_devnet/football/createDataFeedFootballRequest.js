...
const ownerPrivateKey = 'your private key'
...
async function createNewTask() {
  ...
  try {
    // Call the function
    const taskData = ethers.utils.solidityPack(["uint32","uint32","string"],[33,34,"2023-04-02"])

    const result = await contract.requestNewReportWithData(26,taskData);

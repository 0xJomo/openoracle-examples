...
async function createNewTask(taskType, responderThreshold, stakeThreshold) {
...
const taskType = 1; // Example timestamp
const responderThreshold = 5;
const stakeThreshold = 1;
createNewTask(taskType, responderThreshold, stakeThreshold);
